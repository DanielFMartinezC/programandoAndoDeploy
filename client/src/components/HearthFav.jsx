...
import { updateUser, getFavorites } from "../redux/actions";
import axios from "axios";

export default function HearthFav({ course, userObj, cursosActuales }) {
    ...
    >
      {/* {existFavorite? setStatus("like"): setStatus("unlike")}
       <svg // SIN COLOREAR
        ...
        >
          <path
            strokeLinecap={existFavorite? "" :"round"}
            strokeLinejoin={existFavorite? "": "round"}
